...
class CareerReasonCodes extends StaticModel {
  constructor(props) {
    super(props);

    this.name = 'Career Reson Codes';
    this.formData = {
      code: '',
      statusId: '',
    };
    ...
    this.resourcePath = '/career-reason-codes';
  ...
  updateStore(data) {
    this.props.setOptions({ careerReasonCode: data });
  }
...
const mapStateToProps = (state) => {
  return {
    ...
    data: state.options.careerReasonCode,
  };
};
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(CareerReasonCodes)
);
