...
class IncidenceReasonCodes extends StaticModel {
  constructor(props) {
    super(props);

    this.name = 'Incidence Reson Codes';
    this.formData = {
      code: '',
      statusId: '',
    };
    ...
    this.resourcePath = '/incidence-reason-codes';
  ...
  updateStore(data) {
    this.props.setOptions({ incidenceReasonCode: data });
  }
...
const mapStateToProps = (state) => {
  return {
    ...
    data: state.options.incidenceReasonCode,
  };
};
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(IncidenceReasonCodes)
);
